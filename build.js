...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$draw_rect', '$x', '$y', '$w', '$h', '$color', '$private']);
  return (function($base, $super) {
    function $SpaceCanvas(){};
    var self = $SpaceCanvas = $klass($base, $super, 'SpaceCanvas', $SpaceCanvas);

    var def = self._proto, $scope = self._scope;

    def.canvas = def.width = def.height = def.context = nil;
    ...
    def.$initialize = function() {
      ...
      return self.width = self.canvas.width;
    };

    def.$clear_background = function() {
      var self = this;

      return self.$draw_rect(0, 0, self.width, self.height, "black");
    };

    def.$draw_player = function(player) {
      var self = this;

      return self.$draw_rect(player.$x(), player.$y(), player.$w(), player.$h(), player.$color());
    };

    def.$draw_enemy = function(enemy) {
      var self = this;

      return self.$draw_rect(enemy.$x(), enemy.$y(), enemy.$w(), enemy.$h(), enemy.$color());
    };

    def.$draw_fire = function(fire) {
      var self = this;

      return self.$draw_rect(fire.$x(), fire.$y(), fire.$w(), fire.$h(), fire.$color());
    };

    self.$private();

    return (def.$draw_rect = function(x, y, w, h, color) {
      var self = this;

      self.context.fillStyle = color;
      return self.context.fillRect(x, y, w, h);
    }, nil) && 'draw_rect';
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/space_canvas.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    def.x = nil;
    $opal.cdecl($scope, 'DELTA', 10);

    self.$attr_accessor("x", "y", "w", "h", "color");
    ...
    def.$move_left = function() {
      ...
      return self.x = self.x['$-']((($a = $scope.DELTA) == null ? $opal.cm('DELTA') : $a));
    };

    return (def.$move_right = function() {
      var $a, self = this;
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$-', '$+', '$==', '$move_left', '$move_right']);
  return (function($base, $super) {
    function $Enemy(){};
    ...
    def.x = def.y = nil;
    $opal.cdecl($scope, 'DELTA', 2);

    self.$attr_accessor("x", "y", "w", "h", "color");

    def.$initialize = function(x, y, w, h, color) {
      var self = this;
    ...
    return (def.$move_down = function() {
      var self = this;

      return self.y = self.y['$+'](4);
    }, nil) && 'move_down';
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/enemy.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $range = $opal.range;

  $opal.add_stubs(['$include', '$build', '$each', '$to_proc', '$side?', '$change_enemies_direction', '$enemies_down', '$map', '$move', '$private', '$<=', '$x', '$>=', '$+', '$w', '$-', '$==', '$<<', '$new', '$*']);
  return (function($base, $super) {
    function $Enemies(){};
    var self = $Enemies = $klass($base, $super, 'Enemies', $Enemies);

    var def = self._proto, $scope = self._scope, $a, TMP_1;

    def.enemies = def.world_width = def.direction = nil;
    self.$include((($a = $scope.Enumerable) == null ? $opal.cm('Enumerable') : $a));

    $opal.cdecl($scope, 'ENEMIES_PER_ROW', 10);

    $opal.cdecl($scope, 'SIDE_MARGIN', 10);

    def.$initialize = function(world_width) {
      var self = this;

      self.world_width = world_width;
      self.enemies = [];
      self.direction = "right";
      self.$build(60, "#0000ff");
      self.$build(120, "#0000dd");
      self.$build(180, "#0000bb");
      self.$build(240, "#000099");
      return self.$build(300, "#000077");
    };
    ...
    def.$each = TMP_1 = function() {
      ...
      TMP_1._p = null;
      return ($a = ($b = self.enemies).$each, $a._p = block.$to_proc(), $a).call($b);
    };

    def.$update = function() {
      var $a, $b, TMP_2, $c, TMP_3, self = this;

      ($a = ($b = self.enemies).$each, $a._p = (TMP_2 = function(enemy){var self = TMP_2._s || this, $a;
if (enemy == null) enemy = nil;
      if ((($a = self['$side?'](enemy)) !== nil && (!$a._isBoolean || $a == true))) {
          self.$change_enemies_direction();
          self.$enemies_down();
          return ($breaker.$v = nil, $breaker);
          } else {
          return nil
        }}, TMP_2._s = self, TMP_2), $a).call($b);
      return ($a = ($c = self.enemies).$map, $a._p = (TMP_3 = function(enemy){var self = TMP_3._s || this;
        if (self.direction == null) self.direction = nil;
if (enemy == null) enemy = nil;
      return enemy.$move(self.direction)}, TMP_3._s = self, TMP_3), $a).call($c);
    };

    self.$private();

    def['$side?'] = function(enemy) {
      var $a, $b, self = this;

      return ((($a = enemy.$x()['$<=']((($b = $scope.SIDE_MARGIN) == null ? $opal.cm('SIDE_MARGIN') : $b))) !== false && $a !== nil) ? $a : enemy.$x()['$+'](enemy.$w())['$>='](self.world_width['$-']((($b = $scope.SIDE_MARGIN) == null ? $opal.cm('SIDE_MARGIN') : $b))));
    };

    def.$change_enemies_direction = function() {
      var self = this;
    ...
    def.$enemies_down = function() {
      var $a, $b, self = this;

      return ($a = ($b = self.enemies).$map, $a._p = "move_down".$to_proc(), $a).call($b);
    };

    return (def.$build = function(y, color) {
      var $a, $b, TMP_4, $c, self = this;

      return ($a = ($b = ($range(1, (($c = $scope.ENEMIES_PER_ROW) == null ? $opal.cm('ENEMIES_PER_ROW') : $c), false))).$each, $a._p = (TMP_4 = function(i){var self = TMP_4._s || this, $a;
        if (self.enemies == null) self.enemies = nil;
if (i == null) i = nil;
      return self.enemies['$<<']((($a = $scope.Enemy) == null ? $opal.cm('Enemy') : $a).$new((50)['$+'](i['$*'](60)), y, 40, 40, color))}, TMP_4._s = self, TMP_4), $a).call($b);
    }, nil) && 'build';
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/enemies.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    function $Fire(){};
    var self = $Fire = $klass($base, $super, 'Fire', $Fire);

    var def = self._proto, $scope = self._scope;

    def.y = nil;
    $opal.cdecl($scope, 'WIDTH', 4);

    $opal.cdecl($scope, 'DELTA', 5);
    ...
    def.$w = function() {
      ...
      return (($a = $scope.WIDTH) == null ? $opal.cm('WIDTH') : $a);
    };
    ...
    return (def.$update_position = function() {
      var $a, self = this;

      return self.y = self.y['$-']((($a = $scope.DELTA) == null ? $opal.cm('DELTA') : $a));
    }, nil) && 'update_position';
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/fire.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$new', '$width', '$init_keyboard', '$main_loop', '$clear_background', '$draw_player', '$update_fires', '$update', '$each', '$draw_enemy', '$to_n', '$fire', '$move_left', '$move_right', '$<<', '$x', '$y', '$update_position', '$draw_fire', '$select!', '$>=']);
  return (function($base, $super) {
    function $Game(){};
    ...
    def.canvas = def.player = def.fires = nil;
    def.$initialize = function() {
      var $a, self = this;

      self.canvas = (($a = $scope.SpaceCanvas) == null ? $opal.cm('SpaceCanvas') : $a).$new();
      self.player = (($a = $scope.Player) == null ? $opal.cm('Player') : $a).$new();
      self.enemies = (($a = $scope.Enemies) == null ? $opal.cm('Enemies') : $a).$new(self.canvas.$width());
      return self.fires = [];
    };
    ...
    def.$start = function() {
      ...
      self.$init_keyboard();
      return ($a = ($b = self).$main_loop, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2;
      ...
      self.canvas.$clear_background();
        ...
        self.$update_fires();
        self.enemies.$update();
        return ($a = ($b = self.enemies).$each, $a._p = (TMP_2 = function(e){var self = TMP_2._s || this;
          if (self.canvas == null) self.canvas = nil;
if (e == null) e = nil;
        return self.canvas.$draw_enemy(e)}, TMP_2._s = self, TMP_2), $a).call($b);}, TMP_1._s = self, TMP_1), $a).call($b, 50);
    };

    def.$main_loop = TMP_3 = function(interval) {
      var self = this, $iter = TMP_3._p, block = $iter || nil;

      TMP_3._p = null;
      return setInterval(block.$to_n(), interval);
    };

    def.$init_keyboard = function() {
      var self = this;

      
      window.addEventListener("keydown",
        function(e) {
          if(e.keyCode == 32) { self.$fire() }
          if(e.keyCode == 37) { self.player.$move_left() }
          if(e.keyCode == 39) { self.player.$move_right() }
        },
        false);
    ;
    };
    ...
    def.$fire = function() {
      ...
      return self.fires['$<<']((($a = $scope.Fire) == null ? $opal.cm('Fire') : $a).$new(self.player.$x(), self.player.$y()));
    };

    return (def.$update_fires = function() {
      var $a, $b, TMP_4, $c, TMP_5, self = this;

      ($a = ($b = self.fires).$each, $a._p = (TMP_4 = function(fire){var self = TMP_4._s || this;
        if (self.canvas == null) self.canvas = nil;
if (fire == null) fire = nil;
      fire.$update_position();
        return self.canvas.$draw_fire(fire);}, TMP_4._s = self, TMP_4), $a).call($b);
      return ($a = ($c = self.fires)['$select!'], $a._p = (TMP_5 = function(fire){var self = TMP_5._s || this;
if (fire == null) fire = nil;
      return fire.$y()['$>='](0)}, TMP_5._s = self, TMP_5), $a).call($c);
    }, nil) && 'update_fires';
  })(self, null)
})(Opal);
...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, game = nil;

  $opal.add_stubs(['$new', '$start']);
  ;
  ;
  ;
  ;
  ...
  ;
  ;
  game = (($a = $scope.Game) == null ? $opal.cm('Game') : $a).$new();
  return game.$start();
})(Opal);
